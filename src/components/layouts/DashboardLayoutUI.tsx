...
import type { requireUserOutput } from '../../action/dashboard'
...
/* record: returns and object having key value pair:
      key:sting
      value:  { name: string; icon: any }
*/
const ROUTE_MAP: Record<string, { name: string; icon: any }> = {
