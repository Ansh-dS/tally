...
export const ButtonBlock = {
  ...
  preview: (block?: FormBlock, isOverlay?: boolean, updateBlock?: any) => (
    <Box className={`w-full ${isOverlay ? 'opacity-80' : ''}`}>
      <Stack gap="sm">
        <EditableTitle block={block} isOverlay={isOverlay} updateBlock={updateBlock} defaultText="Submit Action" />
        <Button variant="primary" size="md" className="w-full pointer-events-none shadow-md">
