...
import { OptionsManager } from '@components/editor/common-functions'
import {ChangeTitle} from '../../common-functions'
export function SelectSettings({ block, updateBlock }: { block: FormBlock, updateBlock: any }) {
  return (
    <Stack gap="lg" className="p-m">
      {/* 1. Logic for Required Toggle */}
      ...
      {/* 2. Interactive Logic for Adding/Removing Options */}
