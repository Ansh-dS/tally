...
export const SelectPreview = (block?: FormBlock, isOverlay?: boolean, updateBlock?: any) => (
  <Box className={`w-full ${isOverlay ? 'opacity-80' : ''}`}>
    <Stack gap="sm">
      <EditableTitle block={block} isOverlay={isOverlay} updateBlock={updateBlock} defaultText="Select Menu" />
      {/* Visual only version */}
