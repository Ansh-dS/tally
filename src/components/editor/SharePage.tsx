import {Stack, Box, Text, Card, CardHeader, CardContent, Button, Input, CardTitle, Tabs, Switch, TabsList,TextArea, TabsTrigger, Radio, Badge} from 'components'
                        ...
                        <CardContent>
                            <Stack gap="md">
                                ...
                                <TextArea
                                    readOnly
                                    rows={5}
                                    value={'<iframe src="https://tallybuilder.com/f/xyz" width="100%" height="500" frameborder="0"></iframe>'}
                                />
                                <Box>
