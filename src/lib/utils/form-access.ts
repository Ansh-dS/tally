...
export const fallbacks: Record<string, FormFallbackConfig> = {
  ...
  expired: {
    ...
    description:
      'The deadline to submit has passed. Please contact the form owner if you believe this is a mistake.',
    actionLabel: 'Return to Home',
  ...
  not_published: {
    ...
    description:
      "The form or page you are looking for doesn't exist or has been deleted.",
    actionLabel: 'Return to Home',
    isPasswordProtected: false,
    showActionButton: false,
  },
...
export async function canShowForm({
  ...
  if (expDate && expDate < new Date())
    return { canShow: false, reason: 'expired' }
